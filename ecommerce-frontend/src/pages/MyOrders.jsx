...
const MyOrders = () => {
  ...
  const activeOrders = orders.filter(o => o.status?.toUpperCase() !== 'DELIVERED');
  const pastOrders = orders.filter(o => o.status?.toUpperCase() === 'DELIVERED');
        ...
        {orders.length === 0 ? (
          ...
          <div className="space-y-12">
            {activeOrders.length > 0 && (
              <div>
                <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-5 uppercase tracking-widest flex items-center gap-3">
